...
import com.example.ofir.testfunctionality2.Search.ChildRow;
import com.example.ofir.testfunctionality2.Search.ParentRow;
    ...
    public void filterData(String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (ParentRow parentRow : originalList) {
                ...
                } // end searchviewexpandablelistview.ChildRow childRow: childList)
                if (newList.size() > 0) {
